// function that toggles between classes for the different colored menus
const onClickMenu = (menu) => {
  ...
  document
    .getElementById(`menu-bg-${menu}`)
    .classList.toggle(`change-bg-${menu}`);
  ...
  document
    .getElementById(`nav-title-${menu}`)
    .classList.toggle(`change-nav-title-${menu}`);
};
