...
// function that clicks the next slide button
const clickImage = () => {
  document.getElementById("slider-next").click();
};

// function that changes the image as fast as set by the imageInterval variable
const changeImage = setInterval(clickImage, imageInterval);

// function that stops the change of images to avoid an endless loop
